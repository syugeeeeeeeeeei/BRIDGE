...
const request = {schema_version:"bridge.route.v1",request_id:"sdk-ts",graph:{type:"inline",nodes:[{id:0},{id:1}],edges:[{from:0,to:1,weight:1}]},route:{source:0,target:1,mode:"balanced"},observation:{mode:"off"}};

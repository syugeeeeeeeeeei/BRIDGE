...
- Scenario Schemaを`bridge.benchmark.v1`へ更新
...
- `go test ./...`: 成功
- `bridge scenario validate tests/examples/benchmark-smoke-v1.json`: 成功
- `bridge benchmark run tests/examples/benchmark-smoke-v1.json`: 成功
